      ...
      <nav className="fixed top-0 left-0 w-full z-50 glass border-b border-white/5">
        <div className="container-custom flex items-center justify-between h-16 md:h-20">
          <div className="flex items-center gap-2 cursor-pointer" onClick={() => scrollTo('home')}>
            ...
            <span className="text-lg font-medium text-white/80 hidden sm:inline">usparaj</span>
            <span className="text-lg font-medium text-white/40 hidden sm:inline">.</span>
            <span className="text-lg font-medium text-white/60 hidden sm:inline">Magar</span>
          </div>
