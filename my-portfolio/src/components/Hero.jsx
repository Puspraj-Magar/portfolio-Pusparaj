      ...
      <div className="container-custom relative z-10 py-20 md:py-28">
        <motion.div variants={containerVariants} initial="hidden" animate="visible" className="max-w-3xl">
          ...
          <motion.div variants={itemVariants} className="mt-8 flex flex-wrap gap-4">
            ...
            <a href={portfolioData.resumeLink} download="Pusparaj_resume.pdf" className="px-7 py-3 rounded-full glass-light text-white/80 hover:text-white font-medium transition-all duration-300 flex items-center gap-2 border border-white/10 hover:border-indigo-400/30">
