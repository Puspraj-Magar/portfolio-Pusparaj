...
import {  FaGithub, FaLinkedinIn, FaEnvelope, FaRocket } from 'react-icons/fa';
    ...
    <footer className="border-t border-white/5 py-8 mt-8 glass">
      <div className="container-custom flex flex-col md:flex-row justify-between items-center gap-4">
        <p className="text-white/30 text-sm">
          &copy; {currentYear} {portfolioData.name}.   Thank you for visiting my portfolio. Let’s build something amazing together! <FaRocket className="text-indigo-400 inline mx-1" />
        </p>
